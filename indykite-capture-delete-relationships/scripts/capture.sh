#!/usr/bin/env bash
# capture.sh - batch delete relationships via POST /capture/v1/relationships/delete (Capture API).
#
# Required env vars:
...
#             assets/delete-relationships.json. Use "-" for stdin.
#
# Usage:
#   ./capture.sh assets/delete-relationships.json
#   cat body.json | ./capture.sh -
#   ./capture.sh --print assets/delete-relationships.json   # print the curl (token redacted), don't run it

set -euo pipefail

ENDPOINT="/capture/v1/relationships/delete"
