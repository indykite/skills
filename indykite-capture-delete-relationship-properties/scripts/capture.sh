#!/usr/bin/env bash
# capture.sh - batch delete relationship properties via POST /capture/v1/relationships/properties/delete (Capture API).
#
# Required env vars:
...
#             assets/delete-relationship-properties.json. Use "-" for stdin.
#
# Usage:
#   ./capture.sh assets/delete-relationship-properties.json
#   cat body.json | ./capture.sh -
#   ./capture.sh --print assets/delete-relationship-properties.json   # print the curl (token redacted), don't run it

set -euo pipefail

ENDPOINT="/capture/v1/relationships/properties/delete"
