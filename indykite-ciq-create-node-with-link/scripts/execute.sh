#!/usr/bin/env bash
# execute.sh — call POST /contx-iq/v1/execute to run a combined-create Knowledge Query.
#
# Required env vars:
...
#   echo '{"vehicleID":"car2","personID":"ryan","contract_external_id":"ct853","contractNumber":"rbjh853"}' \
#     | ./execute.sh -
