...
#                 assets/evaluation-provision-server.json. Use "-" for stdin.
#
# Usage:
#   ./evaluate.sh assets/evaluation-provision-server.json
#   cat req.json | ./evaluate.sh -
#   ./evaluate.sh --print assets/evaluation-provision-server.json   # print the curl (tokens redacted), don't run it
